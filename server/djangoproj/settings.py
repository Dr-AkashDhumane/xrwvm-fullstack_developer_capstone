...
# 🔹 UPDATED: Add your application URL when running in Skills Network
ALLOWED_HOSTS = [
    'localhost',
    'https://djakash9766-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai'
]
